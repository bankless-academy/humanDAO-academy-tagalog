  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Dahil <code>private key</code> lamang ang kailangan para buksan ang iyong <code>wallet</code>, </p><p>Not all wallets let you control your private key. With a <code>custodial wallet</code>, another party controls it. Accounts on Coinbase and Kraken are examples of custodial wallets that hold your private key, dapat siguraduhin mo ito na pribado at ligtas.</p><p>Maaaring ito lang ang kailangan ng ibang tao, pero kinakailangan mong magtiwala sa mga <em>third parties</em> o grupo na ito para mapanatiling ligtas ang iyong <em>crypto assets</em> at bigyan ka ng <em>access</em> kapag gusto mo itong i-<em>trade</em> o i-<em>send</em> sa iba. Dahil dito, limitado lamang ang magagawa mo sa mundo ng <code>DeFi</code> kung saan may iba’t-ibang aplikasyon na pwedeng gamitin.</p></div><div class="bloc2"><img src=\'/humanDAO/lesson/ano-ang-crypto-wallet/custodial-wallet-5b992b6d.png\'></div>'
      },
      {
        type: 'QUIZ',
      ...
      },
      {
        ...
        content: '<div class="bloc1"><p>Isa sa pinaka-magandang paraan para maprotektahan ang iyong <code>private key</code> ay ang <code>non-custodial wallet</code>. Nagsisilbi ito bilang pasaporte papunta sa iba’t ibang oportunidad na mahahanap sa <code>DeFi</code> at <code>Web3</code>.</p><p>Paalala: kung ang iyong <em>private key</em> ay mawala, hindi mo maa-<em>access</em> ang iyong <em>wallet</em> para gamitin, i-<em>withdraw</em>, o i-<em>transfer</em> ang iyong <em>crypto assets</em>.</p><p>Sa kabutihang palad, pwede mo pa rin ma-<em>recover</em> ang iyong <em>wallet</em> gamit ang iyong <code>recovery phrase</code>. Pero kung mawala mo rin ito, hindi na ito maa-<em>access</em> habang-buhay.</p></div><div class="bloc2"><img src=\'/humanDAO/lesson/ano-ang-crypto-wallet/non-custodial-wallet-b41de715.png\'></div>'
      },
      {
        type: 'QUIZ',
